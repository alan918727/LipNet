...
#
train_gen=lip_gen.get_batch(0,4,train=True)
#val_gen=lip_gen.get_batch(0,100,train=False)
##
#
...
#checkpoint  = ModelCheckpoint('D:/GitHub/LipNet/training/unseen_speakers/results/bestmodel.h5', monitor='val_loss', save_weights_only=False, save_best_only=True,mode='auto', period=1)
...
lipnet.model.fit(x=train_gen[0],y=train_gen[1],batch_size=6,epochs=30,verbose=1,
