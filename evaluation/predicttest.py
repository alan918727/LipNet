...
weight_path='D:/GitHub/LipNet/evaluation/models/weights368.h5'
#weight_path='D:/GitHub/LipNet/training/unseen_speakers/results/0917model.h5'
video_path='D:/video/testvideo/bbal8p.mpg'
...
def predict(weight_path, video_path, absolute_max_string_len=32, output_size=28):
    ...
    return (video, result,y_pred)

if __name__ == '__main__':
    video, result,y_pred= predict(weight_path,video_path)
